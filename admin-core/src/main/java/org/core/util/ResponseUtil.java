 ...
 * </ul>
 * <li> 6xx，小商城后端业务错误码，
 * 具体见shenniudata-admin-api模块的AdminResponseCode。
 * <li> 7xx，管理后台后端业务错误码，
 * 具体见shenniudata-wx-api模块的WxResponseCode。
 * </ul>
 */
public class ResponseUtil {
    ...
    public static Object okList(List list) {
        ...
        if (list instanceof Page) {
            ...
            data.put("page", page.getPageNum());// 当前页
            data.put("limit", page.getPageSize()); // 每页显示多少条
