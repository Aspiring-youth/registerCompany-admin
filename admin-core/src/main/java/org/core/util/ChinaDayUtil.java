...
public class ChinaDayUtil {
    private final static Log log = (Log) LogFactory.getLog(ChinaDayUtil.class);
    private int year;
    private int month;
    private int day;
    ...
    final public String animalsYear() {
        final String[] Animals = new String[]{"子鼠", "丑牛", "寅虎", "卯兔", "辰龙", "巳蛇", "午马", "未羊", "申猴", "酉鸡", "戌狗", "亥猪"};
     ...
     * @return
     */
    public ChinaDayUtil(Calendar cal) {
        int leapMonth = 0;
        Date baseDate = null;
        try {
...
//        return year + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + getChinaDayString(day);
    ...
    /**
     * 入参String格式为：yyyyMMdd
     *
     * @param
     * @return
     */
    public static String getChinaDay(LocalDateTime localDateTime) {
        ...
        ChinaDayUtil lunar = new ChinaDayUtil(cal);
        String str = lunar.year + "年" + lunar.month + "月" + lunar.day + "日";
        System.out.println(str);
        return lunar.animalsYear() + " " + lunar;
    }

    public static void main(String[] args) {
        String chinaDay = getChinaDay(LocalDateTime.now());// 入参String格式为：yyyyMMdd

        System.out.println(chinaDay);
    }
